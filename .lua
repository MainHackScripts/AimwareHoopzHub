...
local Dropdown = AnimationTab:CreateDropdown({
   Name = "Animations",
   Options = {
loadstring(game:HttpGet('https://raw.githubusercontent.com/MainHackScripts/HoopzAnimations/main/.lua'))()}, 
   CurrentOption = {nil},
...
local Dropdown = AnimationTab:CreateDropdown({
   ...
   Options = {loadstring(game:HttpGet('https://raw.githubusercontent.com/MainHackScripts/DunkAnimations/main/.lua'))()},
   CurrentOption = {nil},
   MultipleOptions = true,
   Flag = "Dropdown1", -- A flag is the identifier for the configuration file, make sure every element has a different flag if you're using configuration saving to ensure no overlaps
   Callback = function(Option)
